...
import 'maptracking_model.dart';
export 'maptracking_model.dart';
...
class _MaptrackingWidgetState extends State<MaptrackingWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'maptracking'});
                ...
                children: [
                  Text(
                    FFLocalizations.of(context).getText(
                      'o2icnip5' /* Google Maps is not supported i... */,
                    ),
